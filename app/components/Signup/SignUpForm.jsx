...
} from '../../firebase'; // Adjust the path as per your config
...
export default function SignUpForm() {
    ...
    const handleModalClose = () => {
        ...
        router.push('/Login'); // Redirect to login page after closing the modal
    };
    ...
    return (
        <main className="w-full h-screen flex flex-col items-center justify-center bg-gray-50 sm:px-4">
            ...
            {/* Show the success modal when user signs up */}
            {showSuccessModal && <Success email={email} onClose={handleModalClose} />}
        </main>
    );
}
